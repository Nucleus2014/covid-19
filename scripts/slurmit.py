...
def gen_varkey():
	...
	vars.append(('partition', 'partition', str, 'p_sdk94_1', False, 'regular', 'The SLURM partition to run on (--partition).'))
	...
	vars.append(('begin', 'begin', str, "now", False, 'regular', 'The time to start the script.  By default, 15 minutes after submission to avoid overloading the scheduler.'))
